...
def test_clients():
    # test params
    host = "192.166.253.117" # "trainmydonkey.com" for virtual racing server
    port = 9091
    num_clients = 1
    clients = []
    time_to_drive = 1.0
    ...
    # Car config
    msg = '{ "msg_type" : "car_config", "body_style" : "car01", "body_r" : "0", "body_g" : "255", "body_b" : "0", "car_name" : "Chrimo", "font_size" : "25" }'
    clients[0].send(msg)
    time.sleep(1)
